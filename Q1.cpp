...
int main() {
    Teacher teacher("John Sam", 35, "123 Elmart Street", "Y008", "Math", 20, 50.0);
   
    Student student1("Edward Brown", 19, "456 Happy Street", "S1001");
    Student student2("Bob Cullen", 17, "789 Pineyard Street", "S1002");

    teacher.assignGrade(student1, 89, 95, 58);
    teacher.assignGrade(student2, 88, 72, 70);
